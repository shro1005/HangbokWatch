...
//    private Long deaths;
     ...
     * 영웅별 특수 데이터
     */
    @Column(name = "pulse_bomb_stick_avg")
    private String pulseBombStickAvg;

    @Column(name = "pulse_bomb_kill_avg")
    private String pulseBombKillAvg;
    ...
    public String toString() {
        return "Tracer{" +
                ...
                ", pulseBombStickAvg='" + pulseBombStickAvg + '\'' +
                ", pulseBombKillAvg='" + pulseBombKillAvg + '\'' +
