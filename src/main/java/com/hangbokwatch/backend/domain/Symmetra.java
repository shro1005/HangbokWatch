...
@Getter
@Entity(name="Symmetra")
@Builder
@AllArgsConstructor
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class Symmetra {  //0x02E0000000000016
    /**공통 데이터*/
    @Id
...
//    private Long deaths;
    ...
    @Column(name = "teleport_using_avg")
    private String teleportUsingAvg;
    ...
    public String toString() {
        return "Symmetra{" +
                ...
                ", teleportUsingAvg='" + teleportUsingAvg + '\'' +
