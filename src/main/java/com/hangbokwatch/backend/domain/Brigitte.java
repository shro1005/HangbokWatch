...
//    private Long deaths;
    ...
    /**영웅별 특수 데이터*/
    @Column(name = "armor_per_life")
    private String armorPerLife;

    @Column(name = "inspire_active_rate")
    private String inspireActiveRate;
    ...
    public String toString() {
        return "Brigitte{" +
                ...
                ", armorPerLife='" + armorPerLife + '\'' +
                ", inspireActiveRate='" + inspireActiveRate + '\'' +
                ", goldMedal='" + goldMedal + '\'' +
