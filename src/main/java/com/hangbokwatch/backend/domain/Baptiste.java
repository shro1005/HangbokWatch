...
//    private Long deaths;
    ...
    /**영웅별 특수 데이터*/
    @Column(name = "immortality_field_save_avg")
    private String immortalityFieldSaveAvg;

    @Column(name = "amplification_matrix_avg")
    private String amplificationMatrixAvg;
    ...
    public String toString() {
        return "Baptiste{" +
                ...
                ", immortalityFieldSaveAvg='" + immortalityFieldSaveAvg + '\'' +
                ", amplificationMatrixAvg='" + amplificationMatrixAvg + '\'' +
                ", goldMedal='" + goldMedal + '\'' +
